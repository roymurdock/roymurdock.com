...
<h1>Death of the iPhone</h1>

<p><img src="1005banner.jpg" alt="Coming Soon" width="720px"/></p>

<p>I was reading <a href="http://www.wired.com/gadgetlab/2013/09/more-is-better/">this article</a> on the shortcomings of Siri in iOS7, and it got me thinking about the following:</p>

<ul>
<li>What are people coming to expect from their phones?</li>
<li>How are these expectations being met (or not)?</li>
...
<p>By removing anything potentially confusing or hard about using a smartphone and simplifying the most essential tasks, Apple curated the smartphone experience to the average consumer - a largely untapped market. Success followed to the tune of billions in sales.</p>

<p>Yes, Apple’s marketing department also did a brilliant job of creating demand for the iPhone, but it is simply wrong to write off the iPhone as a marketing gimmick, purchased only by Apple fanboys and consumer sheep.</p>

<p>I once had a marketing professor who taught us about meeting customer expectations:</p>

<blockquote><p>Always underpromise and overdeliver. Marketing is a tool that will get your product into the hands of the consumers, but it can’t change their feelings about it once they actually use it. If you promise too much and underdeliver, your customers will be disappointed and frustrated. They will angrily reject your product because you have broken their trust. They will probably never buy another product from you again, and they will go out of their way to warn other consumers about their negative experience. Underpromise and overdeliver and you’ll have a WOW situation: one where the customer is simply ecstatic with their purchase. It’s the WOW situation you’re after. This turns consumers into loyal customers who will appreciate your honesty and enjoy their experience with your brand.</blockquote></p></blockquote>

<p>Apple used great marketing to get the iPhone into the hands of consumers, but it was the <strong>curation of the experience</strong> that created the WOW situation for their happy customers. Take for example the first gen iPhone ads: They promised a seamless browsing experience that would give you the essentials: music, videos, email, photos, maps, and the internet.</p>


<iframe width="720" height="400" src="https://www.youtube.com/embed/6lZMr-ZfoE4?autoplay=0" frameborder="0" allowfullscreen></iframe>
...
<p>But now I’m beginning to see a problem for Apple and the iPhone. Sure, sales were great last weekend with Apple moving a <a href="http://www.theguardian.com/technology/2013/sep/23/iphone-5s-5c-apple-record-nine-million" target="_blank">record 9 million new units</a>, but I really don’t see the kind of innovation behind the 5s that would warrant record-breaking growth. For a complete qualification of this statement, check out my article on why the 5s is <a href="http://roymurdock.com/essays/2013/09/how-useful-is-the-new-iphone/" target="_blank">not particularly useful</a>. Another symptom of the iPhone’s frailty is the <a href="https://www.youtube.com/watch?v=8eSrdgTHhK0" target="_blank">processing power wall</a> that Apple seems to have recently run up against.<sup id="fnref:1"><a href="#fn:1" rel="footnote">1</a></sup> The 5s is undoubtedly much more powerful than the 1st gen iPhones, but the difference is minuscule when compared to the 5.</p>

<p>The underlying problem here is that the iPhone has no more room for “useful”. Software-wise, Apple can only fuss about with the superficial aspects of the phone: the color palette, the design scheme, the user interface. The new hardware it introduced is gimmicky at best, and does not support any potential for future innovation. Google has virtually <i>unlimited</i> room for “useful”. Why? Google has data. A lot of it. More data means smarter applications. Let’s take a look at Google Now and Siri to see which one does a better job of curation.</p>

<p><a href="https://www.youtube.com/watch?feature=player_detailpage&amp;v=PAs6yQUCkno#t=107" target="_blank"></p>

<p>Here’s a great intro video to Google Now</a>. It can pull up movie times when you’re near a movie theater, a public transit schedule when you’re near a train or bus station, your flight records when it comes close to departure time, interesting stock movements based on your portfolio, the number of miles you’ve walked and biked in the past month, etc. It gives you the information you need without even necessitating an interaction with your phone. This is referred to as <strong>predictive technology</strong>. Google Now is smart enough to know what you want before you even have to ask for it.</p>

<p>Right off the bat, Siri requires more work because it is a <strong>responsive technology</strong>. You need to give Siri a prompt to get the information you want from it. Functionality-wise, Siri (and all of iOS7 for that matter) can only perform half of the Google Now functions using twice the amount of effort and time, using decentralized apps that aren’t nearly as smart and responsive as the clusters of information given to you by Google Now. Siri + Fandango + Yelp + Facebook + Passbook + Nike Tracker + <strong>Big Data</strong> = Google Now. So how can Apple get the <strong>Big Data</strong> to make this equation balance out?</p>
...
<ol>
<li id="fn:1">
<p>Thanks to Jay Lee for pointing this out to me.<a href="#fnref:1" rev="footnote">^</a></p></li>
</ol>
</div>
